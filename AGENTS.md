...
The register pattern, and memento's reference implementation. This is the ONE
agent doc for this repo; `CLAUDE.md` imports it.
...
This file is a **maintainer doc**: how to work *on* this repo. `README.md`,
